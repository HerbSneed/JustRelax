  ...
  return (
    <>
      <div id="hero" className="relative bg-white mx-auto h-96">
        <div className="absolute w-full h-full flex z-10 flex-col px-8">
          ...
          <button className="mt-6 py-[6px] bg-click hover:bg-buttonFocus w-[120px] rounded-md mx-auto">Book Now</button>
        </div>
